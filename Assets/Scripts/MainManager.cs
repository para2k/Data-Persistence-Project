...
public class MainManager : MonoBehaviour
{
    ...
    {
        if (m_Points > int.Parse(HighScoreText.text.Trim().Split(':')[2]))
        {
            SaveHighScore();
            HighScoreText.text = $"Best Score : {PlayerManager.Instance.playerName} : {m_Points}";
        }
        m_GameOver = true;
    ...
    public void SaveHighScore()
    {
        ...
        highScore.name = PlayerManager.Instance.playerName;
